...
### High Priority
- [ ] Load Figures in RAM memory, display them on the screen
- [ ] Implement Loading an scene saved on RAM memory
- [ ] Implement Loading an bitmap from a file
- [ ] Implement Saving an bitmap to a file
...
### High Priority
- [ ] Add submenu support for better organization
- [ ] Add help/info screen showing controls
- [ ] Add menu highlighting and better visual feedback

## 💾 File Operations

### High Priority
- [ ] Implement save drawing to file (simple format)
- [ ] Add load drawing from file
- [ ] Create screenshot/capture functionality
- [ ] Add export to standard image formats (if feasible)

## ⚡ Performance & Optimization

### High Priority
- [ ] Optimize critical drawing loops
- [ ] Implement dirty rectangle updates (only redraw changed areas)
