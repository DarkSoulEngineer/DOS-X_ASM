...
- **Architecture** - System design, memory model, interrupts, video modes

### Reference
- **Modules** - Detailed module documentation, call graphs, interaction flows

## Quick Reference

### Build Commands
```batch
# Build with default (MAIN.ASM)
scripts\build.bat
